...
export default class MenuController {
    public getAll(): Promise<ServiceResponse> {
        return new Promise((resolve: any) => {
            ...
            menuList.push(new MenuItem('Dashboard', '/dashboard', new Array<UserRoleEnum>(UserRoleEnum.User), 'Your personal dashboard'));
            menuList.push(new MenuItem('Dashboard', '/admin-dashboard', new Array<UserRoleEnum>(UserRoleEnum.Admin), 'Administrator dashboard'));
            menuList.push(new MenuItem('Manage Users', '/admin-dashboard/manage-users', new Array<UserRoleEnum>(UserRoleEnum.Admin), 'My projects'));
